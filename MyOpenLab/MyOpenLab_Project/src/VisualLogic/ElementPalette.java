...
// TODO add your handling code here:
    ...
    {//GEN-HEADEREND:event_jPanelButtonsMousePressed
        if (evt.getButton()==3 )
        {
            ...
            } else jmiPaste.setEnabled(false);
    ...
    private void jmiPasteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jmiPasteActionPerformed
        ...
        if (modus==MODE_COPY)
        {
            ...
            else Tools.showMessage(java.util.ResourceBundle.getBundle("VisualLogic/ElementPalette").getString("Element ist bereits vorhanden"));
