...
{        
    ...
    public Component getTreeCellRendererComponent(JTree tree,Object value,boolean sel, boolean expanded,boolean leaf,int row, boolean hasFocus)
    {
        ...
        if (node.isProject)
        {            
            setText(new File(node.projectPath).getName());
        }else        
        if (node.isFolder)
        {
...
public class ProjectPalette extends javax.swing.JPanel
{
    ...
    private ImageIcon iconVM=new javax.swing.ImageIcon(getClass().getResource("/projectfolder/text-x-script.png"));
    
    private ImageIcon iconDirCollapsed=new javax.swing.ImageIcon(getClass().getResource("/projectfolder/folder.png"));
    private ImageIcon iconDirExpanded=new javax.swing.ImageIcon(getClass().getResource("/projectfolder/folder-open.png"));
    
    private ImageIcon iconExecCollapsed=new javax.swing.ImageIcon(getClass().getResource("/projectfolder/execfolder.png"));
    private ImageIcon iconExecExpanded=new javax.swing.ImageIcon(getClass().getResource("/projectfolder/execfolder.png"));

    private ImageIcon rootCollapsed=new javax.swing.ImageIcon(getClass().getResource("/projectfolder/user-home.png"));
    private ImageIcon rootExpanded=new javax.swing.ImageIcon(getClass().getResource("/projectfolder/user-home.png"));    
    
    private ImageIcon iconProjectCollapsed=new javax.swing.ImageIcon(getClass().getResource("/projectfolder/package-x-generic.png"));
    private ImageIcon iconProjectExpanded=new javax.swing.ImageIcon(getClass().getResource("/projectfolder/package-x-generic.png"));    
    
    
    private ImageIcon iconImage=new javax.swing.ImageIcon(getClass().getResource("/projectfolder/image-x-generic.png"));
    private ImageIcon iconHTML=new javax.swing.ImageIcon(getClass().getResource("/projectfolder/text-html.png"));
    
    private ImageIcon iconOther=new javax.swing.ImageIcon(getClass().getResource("/projectfolder/page_deny.gif"));
        ...
        for (int i=0;i<files.length;i++)
        {
            ...
            if (f.exists())
            {
                ...
                }else
                {
                    ...
                    if (extension!=null &&  ( extension.equalsIgnoreCase("html") || extension.equalsIgnoreCase("htm") || extension.equalsIgnoreCase("txt")) ) 
                    {
        ...
        if (button==3)
        {
            if(selRow != -1)
            {
                ...
                if (o instanceof MyNode)
                {
                    ...
                    {
                      selectedNode=node;
                      popupMenuDir.show(jTree1, evt.getX(),evt.getY());
                    }else                    
                    {
                      selectedNode=node;                      
